...
If you are interest to contribute to the evolution of the SystemC ecosystem, please submit your project proposal along with your resume to **ssoc[at]lists.accellera.org** starting March 3. The application deadline is April 4. Students are encouraged to apply quickly, as there are limited seats available. Students are notified not later than April 7.
 ...
 * March 3: Start submitting your application to [ssoc@lists.accellera.org](mailto:ssoc@lists.accellera.org) 
