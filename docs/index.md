      ...
      <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div class="col-lg-6">
            ...
            <p class="lead">The third SystemC Fika took place on 7 april.<br>The next SystemC Fika is a virtual event at 15 september. The Call for Presentations is now open! </p>
            <a href="/events/scef202209/" class="btn btn-primary btn-lg">Call for Presentations</a>
