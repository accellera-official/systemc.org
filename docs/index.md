      ...
      <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div class="col-lg-6">
            ...
            <p class="lead">The SystemC Evolution Fika took place 30 May 2024. The presentations and recording of the event are now available!</p>
            <a href="/events/scef202405/" target="_blank" class="btn btn-primary btn-lg">Presentations and recording</a>
          </div>
        </div>
      </div>
    </div>
