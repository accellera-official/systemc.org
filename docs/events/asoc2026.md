...
<br>
Accellera Systems Initiative will host the **Accellera Summer of Code (SSoC)** 2026 program and invites students to sign-up for a 12 week programming assignment during the summer period, in close collaboration with the Accellera working groups.
...
If you are interest to contribute to the evolution of any of the Accellera standards or associated supplemental material hosted on [GitHub](https://github.com/accellera-official/), please submit your application to [asoc@lists.accellera.org](mailto:asoc@lists.accellera.org). Applications can be submitted from **March 2**. The application deadline is **April 3**.
